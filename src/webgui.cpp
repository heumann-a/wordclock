...
String WebGui::createStyleSheet() {
  String content = "";
...
String WebGui::htmlOption(const String& label, const String& value, const String& store) {
...
String WebGui::index() {
  ...
  content += "<style>";
  content += WebGui::createStyleSheet();
  content += "</style>";
  content += "<script>";
  content += WebGui::createScript();
  content += "</script>";
  content += "</head>";
  content += "<body>";

  content += "<div id=\"c\">";
  content += WebGui::createNav();
